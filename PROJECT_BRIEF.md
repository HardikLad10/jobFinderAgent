...
- **Next build:** v2 coverage expansion — LCA seed (locked rules below) → ATS discovery → non-LCA sources next.
...
**Explicit:** LCA is help for discovery, not the full Midwest universe. Non-LCA automated seeds are the next step after this seed + ATS resolve pass.
